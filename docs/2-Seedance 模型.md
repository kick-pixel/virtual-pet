...
| |图生视频\-首帧|帧率: 24 fps|_ RPM 600| |\
| |文生视频 |时长: 4~12 秒|_ 并发数 10| |\
| | |视频格式: mp4 || |\
| | | |flex:| |\
| | | || |\
| | | |_ TPD 5000亿 | |
...
|---|---|---|---|
|resolution|_ 480p|_ 480p|_ 480p|\
|分辨率 |_ 720p|_ 720p|_ 720p|\
| |_ 1080p |_ 1080p |_ 1080p`参考图场景不支持` |
|ratio|_ 16:9|_ 16:9|_ 16:9|\
|宽高比 |_ 4:3|_ 4:3|_ 4:3|\
| |_ 1:1|_ 1:1|_ 1:1|\
| |_ 3:4|_ 3:4|_ 3:4|\
| |_ 9:16|_ 9:16|_ 9:16|\
| |_ 21:9|_ 21:9|_ 21:9|\
| |_ adaptive|_ adaptive`文生视频场景不支持`|_ adaptive`参考图和文生视频场景不支持`|\
| ||||\
| ||||\
| |---|---|---|\
| ||||\
...
| ||||\
| |_ `16:9`：864×496|_ `16:9`：864×480|_ `16:9`：864×480|\
| |_ `4:3`：752×560|_ `4:3`：736×544|_ `4:3`：736×544|\
| |_ `1:1`：640×640|_ `1:1`：640×640|_ `1:1`：640×640|\
| |_ `3:4`：560×752|_ `3:4`：544×736|_ `3:4`：544×736|\
| |_ `9:16`：496×864|_ `9:16`：480×864|_ `9:16`：480×864|\
| |_ `21:9`：992×432|_ `21:9`：960×416|_ `21:9`：960×416|\
| ||||\
| ||||\
| |---|---|---|\
| ||||\
...
| ||||\
| |_ `16:9`：1280×720|_ `16:9`：1248×704|_ `16:9`：1248×704|\
| |_ `4:3`：1112×834|_ `4:3`：1120×832|_ `4:3`：1120×832|\
| |_ `1:1`：960×960|_ `1:1`：960×960|_ `1:1`：960×960|\
| |_ `3:4`：834×1112|_ `3:4`：832×1120|_ `3:4`：832×1120|\
| |_ `9:16`：720×1280|_ `9:16`：704×1248|_ `9:16`：704×1248|\
| |_ `21:9`：1470×630|_ `21:9`：1504×640|_ `21:9`：1504×640|\
| ||||\
| ||||\
| |---|---|---|\
| ||||\
...
| ||||\
| |_ `16:9`：1920×1080|_ `16:9`：1920×1088|_ `16:9`：1920×1088|\
| |_ `4:3`：1664×1248|_ `4:3`：1664×1248|_ `4:3`：1664×1248|\
| |_ `1:1`：1440×1440|_ `1:1`：1440×1440|_ `1:1`：1440×1440|\
| |_ `3:4`：1248×1664|_ `3:4`：1248×1664|_ `3:4`：1248×1664|\
| |_ `9:16`：1080×1920|_ `9:16`：1088×1920|_ `9:16`：1088×1920|\
| |_ `21:9`：2206×946 |_ `21:9`：2176×928 |_ `21:9`：2176×928 |
