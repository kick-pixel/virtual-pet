<template>
  <!-- 导入表 -->
  <el-dialog :title="$t('gen.importTable')" v-model="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="dbTableList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column prop="tableName" :label="$t('gen.tableName')" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="tableComment" :label="$t('gen.tableComment')" :show-overflow-tooltip="true"></el-table-column>
...
function handleImportTable() {
  ...
  if (tableNames == "") {
    proxy.$modal.msgError(t('gen.selectTableError'))
    return
  }
