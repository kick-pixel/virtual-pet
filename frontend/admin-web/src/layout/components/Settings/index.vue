<template>
  <el-drawer v-model="showSettings" :withHeader="false" :lock-scroll="false" direction="rtl" size="300px">
    <div class="setting-drawer-title">
      <h3 class="drawer-title">{{ $t('settings.navMode') }}</h3>
    </div>
    <div class="nav-wrap">
      <el-tooltip :content="$t('settings.sideNav')" placement="bottom">
        <div class="item left" @click="handleNavType(1)" :class="{ activeItem: navType == 1 }">
          <b></b><b></b>
        </div>
      </el-tooltip>

      <el-tooltip :content="$t('settings.mixNav')" placement="bottom">
        <div class="item mix" @click="handleNavType(2)" :class="{ activeItem: navType == 2 }">
          <b></b><b></b>
        </div>
      </el-tooltip>
      <el-tooltip :content="$t('settings.topNav')" placement="bottom">
    ...
    <div class="setting-drawer-title">
      <h3 class="drawer-title">{{ $t('settings.theme') }}</h3>
    </div>
    ...
    <h3 class="drawer-title">{{ $t('settings.layoutStyle') }}</h3>
    ...
    <div class="drawer-item">
      <span>{{ $t('common.showTagsIcon') }}</span>
      <span class="comp-style">
...
function saveSetting() {
  proxy.$modal.loading(t('common.savingConfig'))
  let layoutSetting = {
...
function resetSetting() {
  proxy.$modal.loading(t('common.resettingConfig'))
