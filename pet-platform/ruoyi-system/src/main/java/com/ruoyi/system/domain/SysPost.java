...
public class SysPost extends BaseEntity
{
    ...
    @Size(min = 0, max = 64, message = "Post code length must be between 0 and 64 characters")
    ...
    @Size(min = 0, max = 50, message = "Post name length must be between 0 and 50 characters")
